...
prompt_fps=(
    "./prompts/cweval/ima_detailed.txt"
    "./prompts/cweval/voi_detailed.txt"
    "./prompts/cweval/ori_detailed.txt"
)
...
for writer_model in "${writer_models[@]}"; do
    ...
    for prompt_fp in "${prompt_fps[@]}"; do
        ...
        data_fp="./data/cweval_data_alonzogarbanzo/${model_name}.json"
