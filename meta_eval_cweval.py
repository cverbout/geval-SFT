...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_fp', type=str, default='results/gpt4_ima_detailed_Bloom-1b7-creative-writing-IT-baseline.json')
    parser.add_argument('--dimension', type=str, default='imagery')
